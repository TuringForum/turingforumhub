  ...
  const handleCreateAIWikiPage = useCallback(async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Created new wiki page: "${title}" with AI-generated content.`,
      });
    } catch (error) {
      ...
      <div className="flex flex-wrap gap-1 p-2 border-b border-input justify-between">
        ...
        <div className="flex gap-1">
          <AIAssistant
            ...
            onResult={(result) => {
              // Insert the AI-generated text at current cursor position
          ...
          >
            <FileText className="h-4 w-4" />
            {createPage.isPending ? 'Creating...' : 'Add AI Wiki Page'}
          </Button>
        </div>
      </div>
      <EditorContent 
